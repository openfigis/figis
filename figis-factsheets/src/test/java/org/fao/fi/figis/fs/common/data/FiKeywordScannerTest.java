...
public class FiKeywordScannerTest {
	 ...
	 * 
	 * The logic generates this error. I do not understand the exact cause of
	 * this error but it is not blocking:
	 * 
	 * WARN SessionFactoryObjectFactory - Could not bind factory to JNDI
	 ...
	 * 
	 * See also FiKeywordScannerLuceneTest
	 * 
	 */
	@Test
